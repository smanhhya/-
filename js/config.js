...
const textsConfig = [
    ...
    { id: 'successTitle', label: 'عنوان شاشة نجاح الأوردر', default: 'أوردرك اتسجل بنجاح! 🎉' },
    { id: 'successMsgTemplate', label: 'نص رسالة النجاح (اكتب {اليوم} في المكان اللي تحبه)', default: 'الأوردر اتسجل في السيستم وهيتم التجهيز عشان تستلمه إن شاء الله غداً (يوم {اليوم}).<br><br>تحب نأكد التفاصيل ونتابع مع بعض على الواتساب؟' },
    { id: 'waFollowUpBtn', label: 'كلام زرار المتابعة واتساب', default: 'أيوة، المتابعة ع الواتساب' },
    { id: 'closeFollowUpBtn', label: 'كلام زرار إنهاء/انتظار الأوردر', default: 'تمام، هنتظر الأوردر 👍' }
];
